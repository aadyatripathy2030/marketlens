...
window.LESSONS = [
  {
    ...
    quiz: [
      { q: 'What does owning a share represent?', options: ['Part-ownership of the company', 'A loan to the company', 'A guaranteed dividend'], correct: 0, why: 'A share is partial ownership — you own a fraction of the company, not a loan or a guarantee.' },
      { q: 'A stock’s price at any moment is mainly determined by…', options: ['What buyers and sellers agree to trade at', 'The government', 'The company’s CEO'], correct: 0, why: 'Price is set by supply and demand in the market — the latest price two parties agreed on.' },
      ...
      { q: 'Why does a company issue shares in the first place?', options: ['Because the exchange requires it', 'To guarantee investors a profit', 'To raise money without borrowing it'], correct: 2, why: 'Selling part-ownership raises cash the company never has to repay — unlike a loan. There is no guarantee attached.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'An RSI of 78 usually suggests a stock is…', options: ['Oversold', 'Fairly valued', 'Overbought'], correct: 2, why: 'Above ~70 = overbought (stretched to the upside, higher pullback risk). Below ~30 = oversold.' },
      ...
      { q: 'Two indicators disagree — MACD is bullish, RSI says overbought. What does that tell you?', options: ['The bullish one wins', 'The chart is broken', 'Nothing is certain; indicators often conflict'], correct: 2, why: 'Indicators measure different things and routinely disagree. Conflict is normal and is information in itself — it usually means no strong edge either way.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'EPS stands for…', options: ['Earnings per share', 'Equity per stock', 'Expected price signal'], correct: 0, why: 'Earnings per share = net income divided by shares outstanding.' },
      ...
      { q: 'Fundamental analysis focuses on…', options: ['Chart patterns', 'Social media buzz', 'The underlying business results'], correct: 2, why: 'It’s about the business itself — revenue, earnings, margins, balance sheet.' },
      { q: 'A company grows revenue 40% a year but has never made a profit. This is…', options: ['Impossible', 'A guaranteed fraud', 'Common for young companies, and risky'], correct: 2, why: 'Plenty of fast-growing firms lose money for years while they invest. It can work out or not — the risk is that profitability never arrives.' },
      { q: 'Why compare a company\'s margins with its competitors rather than in isolation?', options: ['What counts as a good margin varies hugely by industry', 'Margins are meaningless alone', 'Regulators require it'], correct: 0, why: 'A 4% net margin is normal for a supermarket and alarming for a software firm. Margins only mean something against industry peers.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A P/E of 40 usually implies the market expects…', options: ['High future growth', 'Low growth', 'Bankruptcy'], correct: 0, why: 'A high P/E means investors are paying up for expected growth. If growth disappoints, the price often falls.' },
      { q: 'A PEG ratio near 1.0 suggests…', options: ['Guaranteed gains', 'The stock is worthless', 'Price roughly matches growth'], correct: 2, why: 'PEG ≈ 1 means the P/E is roughly justified by the growth rate — a rough "fair" zone.' },
      { q: 'A DCF valuation is…', options: ['Very sensitive to its assumptions', 'Exact and certain', 'Unaffected by growth rates'], correct: 0, why: 'DCF depends heavily on inputs like growth and discount rate — treat its output as a range, not a fact.' },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: 'Free cash flow is valued because…', options: ['It’s easy to manipulate', 'It ignores capital spending', 'It’s hard to fake and funds dividends/buybacks'], correct: 2, why: 'FCF = operating cash minus capex — real cash the business generates, hard to massage.' },
      { q: 'A company reports strong profits but negative operating cash flow. What is worth checking?', options: ['Nothing, profit is what matters', 'The CEO\'s salary', 'Whether the profit is real cash or accounting entries'], correct: 2, why: 'Profit can be booked before cash arrives. Persistent gaps between earnings and operating cash flow are one of the oldest warning signs there is.' },
      { q: 'Which statement shows what a company owns and owes at a single moment?', options: ['Balance sheet', 'Income statement', 'Cash flow statement'], correct: 0, why: 'The balance sheet is a snapshot of one date. The other two cover a period of time.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'Money you’ll need next month is best…', options: ['In volatile growth stocks', 'Put in options', 'Kept out of volatile assets'], correct: 2, why: 'Short-term money shouldn’t face big swings — you might have to sell at a bad time.' },
      { q: 'You risk 1% of your account per trade and lose eight in a row. Roughly how much is gone?', options: ['Everything', 'About 30%', 'About 8%'], correct: 2, why: 'Around 7.7%, and the account survives easily. The same eight losses at 10% risk each would take nearly 57% — position size, not win rate, is what ends accounts.' },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: 'Dollar-cost averaging is…', options: ['Buying only at all-time highs', 'Investing a fixed amount on a schedule', 'A type of option'], correct: 1, why: 'Investing steadily over time buys more when cheap, fewer when expensive, reducing timing risk.' },
      { q: 'Trying to time short-term moves is…', options: ['Easy and reliable', 'Guaranteed to beat the market', 'Very hard; missing top days hurts'], correct: 2, why: 'Timing is notoriously hard, and missing the best days disproportionately lowers returns.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'Dividend yield equals…', options: ['Dividend × shares', 'Price ÷ earnings', 'Annual dividend ÷ price'], correct: 2, why: 'Yield = annual dividend per share divided by the share price.' },
      { q: 'A dividend yield of 15% might be…', options: ['A warning sign of a possible cut', 'Always great', 'Impossible'], correct: 0, why: 'Unusually high yields often signal a falling price or an unsustainable payout the market expects to be cut.' },
      { q: 'A payout ratio over 100% means…', options: ['No dividend at all', 'Very safe dividend', 'Paying more than it earns'], correct: 2, why: 'Paying out more than earnings is usually unsustainable and risks a cut.' },
      ...
      { q: 'What is a dividend payout ratio telling you?', options: ['How often dividends are paid', 'How much profit is paid out rather than reinvested', 'The tax rate on dividends'], correct: 1, why: 'It is the share of earnings paid as dividends. Very high ratios leave no cushion if profits dip.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'Growth stocks are especially sensitive to…', options: ['Dividend dates', 'Stock splits', 'Interest rates'], correct: 2, why: 'Their value is mostly future profit, which is discounted more heavily when rates rise.' },
      { q: 'Growth investing generally involves…', options: ['Higher risk and higher potential reward', 'Low volatility, steady income', 'Guaranteed dividends'], correct: 0, why: 'You pay up for fast growth — big upside, but sharp drops if growth disappoints.' },
      { q: 'A key thing to check in a growth stock is…', options: ['Only the ticker', 'The CEO’s Twitter', 'Durable, accelerating growth and a moat'], correct: 2, why: 'Sustainable growth and a competitive edge matter more than hype.' },
      ...
      { q: 'A growth company\'s revenue growth slows from 45% to 30%. The stock drops sharply. Why?', options: ['Price reflected expectations, and expectations changed', '30% is a bad number', 'Someone manipulated it'], correct: 0, why: 'Prices embed an expected path. Decelerating growth is still growth, but it is worse than what was priced in.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A "margin of safety" means…', options: ['Using leverage', 'Buying well below your estimate of fair value', 'Buying at all-time highs'], correct: 1, why: 'It’s the cushion you build in by paying less than intrinsic value, protecting against mistakes.' },
      ...
      { q: 'Value investing often underperforms for years at a time. What does that imply?', options: ['The approach is broken', 'It only works on small companies', 'It needs patience and a horizon most people do not have'], correct: 2, why: 'Long stretches of underperformance are part of the method. It demands a holding period many investors cannot actually sustain.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A call option gives the holder the right to…', options: ['Buy a stock at the strike', 'Sell a stock at the strike', 'Collect a dividend'], correct: 0, why: 'A call = right to buy at the strike price; a put = right to sell.' },
      ...
      { q: 'You buy a call option and the stock stays exactly flat until expiry. What happens?', options: ['You break even', 'You keep the option', 'You lose the premium to time decay'], correct: 2, why: 'Options lose value as expiry approaches. Being right about direction is not enough — you have to be right in time.' },
      { q: 'Selling a naked call exposes you to…', options: ['A capped loss', 'No risk if you own the stock', 'Theoretically unlimited loss'], correct: 2, why: 'There is no ceiling on how high a stock can go, so an uncovered short call has no defined maximum loss. This is why brokers restrict it.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A market order guarantees…', options: ['That the order fills', 'The price you saw', 'Both price and fill'], correct: 0, why: 'It guarantees execution, not price. A limit order is the reverse.' },
      ...
      { q: 'You buy at the ask and sell at the bid. This means…', options: ['Spreads are refunded', 'You always profit', 'Every trade starts slightly negative'], correct: 2, why: 'You pay the spread on entry. A trade must move in your favour by at least the spread before it breaks even.' },
      { q: 'A limit order to buy at $20 when the stock is $23 will…', options: ['Wait until price falls to $20 or better', 'Fill immediately at $23', 'Be rejected'], correct: 0, why: 'A buy limit is the maximum you will pay. It rests until the market comes to it, and may never fill.' },
      { q: 'Spreads are usually widest…', options: ['In heavily traded large companies', 'At the market open only', 'In thin, low-volume stocks and outside regular hours'], correct: 2, why: 'Fewer participants means a bigger gap between bid and ask. Thin names and extended hours are where spreads cost the most.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'Why treat levels as zones rather than exact prices?', options: ['Charts are inaccurate', 'Exchanges round prices', 'Price routinely overshoots slightly before reversing'], correct: 2, why: 'Brief piercings are normal. An exact line invites being stopped out by ordinary noise.' },
      ...
      { q: 'Every chart shows levels that held perfectly — in hindsight. The catch is…', options: ['Choosing which level will hold beforehand is much harder', 'The data is wrong', 'They only work on indices'], correct: 0, why: 'Hindsight selects the levels that worked and hides the ones that failed. Forward, most break.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A candle with a long upper wick and small body tells you…', options: ['Volume was zero', 'The stock paid a dividend', 'Buyers pushed price up and were pushed back down'], correct: 2, why: 'The wick marks territory price reached and could not hold. Sellers controlled the close.' },
      ...
      { q: 'What do systematic studies of candlestick patterns generally find?', options: ['Large, reliable edges', 'They work only on Mondays', 'Small or no edge once costs are counted'], correct: 2, why: 'They are far better at describing what happened than at predicting what comes next.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'High volume on an up day tells you…', options: ['Many participants were involved', 'More buyers than sellers', 'The stock is undervalued'], correct: 0, why: 'Every trade has both a buyer and a seller. Volume measures participation, not imbalance.' },
      { q: 'Relative volume of 0.3× means…', options: ['Much quieter than normal for that symbol', 'Unusually busy', 'The stock fell 30%'], correct: 0, why: 'It is today’s volume against that symbol’s own average. Well below 1 means few participants.' },
      { q: 'Slippage is…', options: ['A broker fee', 'A charting error', 'The difference between the price you expected and the price you got'], correct: 2, why: 'It is a genuine cost of trading, and it grows in thin markets and fast moves.' },
      { q: 'When is intraday liquidity usually thinnest?', options: ['At the open', 'At the close', 'Around midday'], correct: 2, why: 'Participation typically dips in the middle of the session, widening spreads.' },
      { q: 'Why does liquidity matter more to a day trader than to a long-term investor?', options: ['Long-term investors pay no spreads', 'Day traders trade far more often, so costs repeat', 'Liquidity only exists intraday'], correct: 1, why: 'A cost paid once a decade barely registers. The same cost paid many times a day compounds against you.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'A trader shows a year of winning results. What is the honest interpretation?', options: ['Possibly skill, possibly chance — one year cannot separate them', 'Proof of skill', 'Proof of fraud'], correct: 0, why: 'Among many traders, long streaks occur by chance. A single track record rarely distinguishes skill from luck.' },
      { q: 'Survivorship bias in trading content means…', options: ['Old strategies stop working', 'Winners are visible and losers are not', 'Brokers delete accounts'], correct: 1, why: 'You see the people it worked for. The much larger group it did not work for does not post.' },
      { q: 'Given a negative base rate, the most rational response is…', options: ['Trade bigger to catch up', 'Avoid all charts', 'Size positions so being wrong is survivable, and measure results honestly'], correct: 2, why: 'You cannot control the base rate, only your exposure to it and your honesty about outcomes.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'Hindsight bias means…', options: ['Old data is unreliable', 'Charts repeat', 'Past events feel more predictable than they actually were'], correct: 2, why: 'Knowing the outcome makes the path to it look obvious. It was not obvious in advance.' },
      { q: 'Why is revenge trading so costly?', options: ['Brokers penalise it', 'It increases position size exactly when judgement is worst', 'It is against exchange rules'], correct: 1, why: 'The impulse to recover a loss immediately pushes size up at the worst possible moment.' },
      { q: 'Pre-set rules work mainly because…', options: ['They are optimised', 'Brokers enforce them', 'They are decided before the emotion arrives'], correct: 2, why: 'The decision is made by a calmer version of you than the one who will be under pressure.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'With a zero-commission broker, what do you still pay on every trade?', options: ['Nothing', 'A monthly fee', 'The bid–ask spread'], correct: 2, why: 'The spread is a cost regardless of advertised commissions, and brokers also earn from routing orders.' },
      ...
      { q: 'In many jurisdictions, gains on positions held over a year are…', options: ['Often taxed at a lower rate than short-term gains', 'Taxed more heavily', 'Never taxed'], correct: 0, why: 'Long-term rates are commonly lower, though the rules vary by country — check your own situation.' },
      { q: 'A fund charging 1% a year versus one charging 0.05% will, over decades…', options: ['Make almost no difference', 'Only matter for large balances', 'Compound into a meaningful gap'], correct: 2, why: 'The fee is charged on the whole balance every year, so it compounds against you alongside your returns.' },
      { q: 'The honest way to judge a strategy is…', options: ['Returns after spread, slippage, fees and tax', 'Gross returns', 'Win rate alone'], correct: 0, why: 'Anything that looks profitable before costs may not survive them. Net is the only number that matters.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'Why does the average active fund trail its index after costs?', options: ['Collectively they are the market, so fees come out of an average return', 'Managers are unskilled', 'Indexes exclude losers'], correct: 0, why: 'Before costs the group earns roughly the market return; fees are then subtracted from it.' },
      ...
      { q: 'What is the trade-off of a concentrated portfolio?', options: ['A much wider range of outcomes, good and bad', 'Higher fees', 'It is not permitted'], correct: 0, why: 'Concentration is how people greatly beat the index and also how they greatly trail it.' },
      { q: 'Why does a low expense ratio matter more over long horizons?', options: ['Fees rise with time', 'Long-term funds charge more', 'It is charged on the whole balance every year and compounds'], correct: 2, why: 'A small annual drag applied to a growing balance becomes a large cumulative gap.' },
    ],
  },
];
